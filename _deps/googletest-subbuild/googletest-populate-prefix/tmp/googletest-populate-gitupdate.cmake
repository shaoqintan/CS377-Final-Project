...
execute_process(
  COMMAND "/bin/git" show-ref "release-1.12.1"
  WORKING_DIRECTORY "/nfs/elsrv4/users4/grad/shaoqintan/cs377/Final project/_deps/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/nfs/elsrv4/users4/grad/shaoqintan/cs377/Final project/_deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/nfs/elsrv4/users4/grad/shaoqintan/cs377/Final project/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
